...
import { OMNIDEF } from './cristiaamGeneralEnglish_def.js';
import tmpl from './cristiaamGeneralEnglish.html';
import tmpl_nds from './cristiaamGeneralEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cristiaamGeneralEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
