...
import { OMNIDEF } from './quoteClosedEnglish_def.js';
import tmpl from './quoteClosedEnglish.html';
import tmpl_nds from './quoteClosedEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quoteClosedEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
