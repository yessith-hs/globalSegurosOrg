...
import { OMNIDEF } from './clb_ins_osCreateAcountEnglish_def.js';
import tmpl from './clb_ins_osCreateAcountEnglish.html';
import tmpl_nds from './clb_ins_osCreateAcountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clb_ins_osCreateAcountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
