...
export default class GpSolucionSeguroVida extends LightningElement {
    ...
    get getSolucionImagen() {
        return globalSegurosPortal + '/images/gp-soluciones-seguro-vida.jpg';
    }
    ...
    get getStyleRamoSeguro() {
        return `background-color: #ff5555; border-color: #ff5555;`
    }
