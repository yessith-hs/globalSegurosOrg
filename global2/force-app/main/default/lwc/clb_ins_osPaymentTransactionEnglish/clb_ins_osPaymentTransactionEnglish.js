...
import { OMNIDEF } from './clb_ins_osPaymentTransactionEnglish_def.js';
import tmpl from './clb_ins_osPaymentTransactionEnglish.html';
import tmpl_nds from './clb_ins_osPaymentTransactionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clb_ins_osPaymentTransactionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
