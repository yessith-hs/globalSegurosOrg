...
import { OMNIDEF } from './quoteOpenEnglish_def.js';
import tmpl from './quoteOpenEnglish.html';
import tmpl_nds from './quoteOpenEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quoteOpenEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
