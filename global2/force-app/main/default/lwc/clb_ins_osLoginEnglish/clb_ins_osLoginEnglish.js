...
import { OMNIDEF } from './clb_ins_osLoginEnglish_def.js';
import tmpl from './clb_ins_osLoginEnglish.html';
import tmpl_nds from './clb_ins_osLoginEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clb_ins_osLoginEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
